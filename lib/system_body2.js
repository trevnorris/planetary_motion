...
class SystemBody {
  constructor(options) {
    ...
    const inic = this.inicon = {
      ...
      periapsis_arg: options.aphelion_angle || 0,
...
/* debug:stop */
    ...
    this[vel_s] = new Vector(
      rotate_main(peri_vel, 0, inic.periapsis_arg),
      rotate_second(peri_vel, 0, inic.periapsis_arg),
      0);
    // Then rotate due to ascending node.
    this[vel_s].y = rotate_main(this[vel_s].y, 0, inic.ascending_node);
    this[vel_s].z = rotate_second(this[vel_s].y, 0, inic.ascending_node);
