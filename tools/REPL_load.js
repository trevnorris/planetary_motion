...
const { orbit_period, orbit_period_days, star_to_period, rotate_main, rotate_second, grshift, grshift_as, darcsec, adiam, sec_to_string, relative_mag } = require('../lib/misc_fns');
